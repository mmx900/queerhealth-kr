...
* [퀴어프렌들리 병의원 및 심리상담기관 안내(@queer_map_kr)](https://x.com/queer_map_kr)에서는 성소수자 친화적인 병의원 및 심리상담기관, 정신건 관련 정보를 제공합니다.
...
* [iSHAP](https://ishap.org/)은 성소수자 직원과 전문의들이 전국 각지에서 정기적으로 HIV검사 및 종합성병검사를 시행합니다. 홈페이지의 검사 일정을 참고하세요. 온라인 상담도 운영합니다.
* iSHAP은 또한 [PrEP 처방을 받을 수 있는 병원의 목록](https://sites.google.com/ishap.org/list/hospital)을 게시중입니다. 
...
아래는 현재 업데이트되고 있지 않아 기록용으로 남겨둡니다.
